output "aws_iam_policy_tfer--AWSLambdaBasicExecutionRole-9192e422-e3c4-4638-8c63-005ffec3b4f0_id" {
  value = "${aws_iam_policy.tfer--AWSLambdaBasicExecutionRole-9192e422-e3c4-4638-8c63-005ffec3b4f0.id}"
}

output "aws_iam_policy_tfer--DynamoDBUpdatePolicy_id" {
  value = "${aws_iam_policy.tfer--DynamoDBUpdatePolicy.id}"
}
...
output "aws_iam_role_policy_attachment_tfer--AWSServiceRoleForEC2Spot_AWSEC2SpotServiceRolePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--AWSServiceRoleForEC2Spot_AWSEC2SpotServiceRolePolicy.id}"
}
...
output "aws_iam_role_policy_attachment_tfer--resumeCount-role-o907i0fj_AWSLambdaBasicExecutionRole-9192e422-e3c4-4638-8c63-005ffec3b4f0_id" {
  value = "${aws_iam_role_policy_attachment.tfer--resumeCount-role-o907i0fj_AWSLambdaBasicExecutionRole-9192e422-e3c4-4638-8c63-005ffec3b4f0.id}"
}

output "aws_iam_role_policy_attachment_tfer--resumeCount-role-o907i0fj_DynamoDBUpdatePolicy_id" {
  value = "${aws_iam_role_policy_attachment.tfer--resumeCount-role-o907i0fj_DynamoDBUpdatePolicy.id}"
}
...
output "aws_iam_role_tfer--AWSServiceRoleForEC2Spot_id" {
  value = "${aws_iam_role.tfer--AWSServiceRoleForEC2Spot.id}"
}
...
output "aws_iam_role_tfer--aws-ec2-spot-fleet-tagging-role_id" {
  value = "${aws_iam_role.tfer--aws-ec2-spot-fleet-tagging-role.id}"
}

output "aws_iam_role_tfer--resumeCount-role-o907i0fj_id" {
  value = "${aws_iam_role.tfer--resumeCount-role-o907i0fj.id}"
}
